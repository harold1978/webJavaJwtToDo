...
public class ToDoActualizarServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ToDoActualizarServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ToDoActualizarServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        crud crud = new crud();
        Tareas tarea = crud.getToDo(id);
        request.setAttribute("todo", tarea);
        request.getRequestDispatcher("paginas/actualizar.jsp").forward(request, response);
